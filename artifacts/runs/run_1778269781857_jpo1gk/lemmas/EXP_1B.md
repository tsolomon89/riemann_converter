...
On this run's window, Naive / wrong operator scaling of the gauge action should fail or visibly diverge under the reconstruction metric held within tolerance (primary metric wrong_scaling_drift_or_amplitude_explosion: observed ≈ 67.9294). Formalizing this as a finite/proxy lemma is the next research step.
