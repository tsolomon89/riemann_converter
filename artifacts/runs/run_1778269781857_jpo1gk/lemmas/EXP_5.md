...
This run was incomplete against the current baseline (primary metric nearest_neighbor_correspondence_signal: observed ≈ 0.259567). No candidate lemma is suggested until the baseline is confirmed or definitively failed.
