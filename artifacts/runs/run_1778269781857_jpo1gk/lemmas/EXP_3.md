...
On this run's window, A counterfactual beta (off the critical line) should diverge from the true / reconstructed prime count under the same gauge scales held within tolerance (primary metric counterfactual_beta_divergence: observed ≈ 17082.2). Formalizing this as a finite/proxy lemma is the next research step.
