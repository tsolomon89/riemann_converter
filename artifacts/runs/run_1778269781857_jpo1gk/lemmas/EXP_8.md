...
```json
{
  "summary_metric": 2.388279452544451e-76
}
```
...
On this run's window, Scaled-zero / scaled-lattice equivalence holds within adaptive tolerance over the tested k-range held within tolerance (primary metric nearest_neighbor_distance_under_scaling: observed ≈ 2.388e-76). Formalizing this as a finite/proxy lemma is the next research step.
