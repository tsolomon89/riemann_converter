...
```json
{
  "summary_metric": 0.25649663672829054
}
```
...
This run was incomplete against the current baseline (primary metric nearest_neighbor_correspondence_signal: observed ≈ 0.256497). No candidate lemma is suggested until the baseline is confirmed or definitively failed.
